...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jaraco.stream-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jaraco.stream-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jaraco.stream
# for installing globally
pixi global install jaraco.stream
```
...
It is possible to list all of the versions of `jaraco.stream` available on your platform:
...
```
pixi search jaraco.stream --channel conda-forge
```
